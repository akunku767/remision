...
Route::post('/login', [AuthControllerAPI::class, 'login'])->name('api.login');

Route::middleware('auth:sanctum')->group(function () {
    Route::post('/check-connectivity', [AuthControllerAPI::class, 'checkConnectivity'])->name('api.checkConnectivity');
