...
@section('content')
                ...
                <div class="card mb-4 mx-4 p-2">
                    ...
                    <div class="card-body px-2 pt-0 pb-2">
                        <div class="table-responsive">
                            <table id="threshold-table" class="table align-items-center mb-0">
                                <thead>
                                    <tr>
                                        <th>No</th>
                                        <th>Kategori</th>
    ...
    <script>
        ...
        function showAll() {
            ...
            if ($.fn.dataTable.isDataTable('#threshold-table')) {
                $('#threshold-table').DataTable().clear().destroy();
            }
            ...
            var table = $('#threshold-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{ route('admin.management.threshold.index') }}",
                columns: [{
                        "data": 'DT_RowIndex',
                        orderable: false,
                        searchable: false,
